var DatatableColumnRenderingDemo= {
    init:function() {
        ...
        t=$(".m_datatable").mDatatable( {
            ...
            , {
                width:200, field:"CompanyAgent", title:"User", template:function(t) {
                    var a=mUtil.getRandomInt(1, 14);
                    if(a>8)output='<div class="m-card-user m-card-user--sm">\t\t\t\t\t\t\t\t<div class="m-card-user__pic">\t\t\t\t\t\t\t\t\t<img src="./assets/app/media/img/users/100_'+a+'.jpg" class="m--img-rounded m--marginless" alt="photo">\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="m-card-user__details">\t\t\t\t\t\t\t\t\t<span class="m-card-user__name">'+t.CompanyAgent+'</span>\t\t\t\t\t\t\t\t\t<a href="" class="m-card-user__email m-link">'+t.CompanyName+"</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>";
                    else {
                        var e=mUtil.getRandomInt(0, 7);
                        output='<div class="m-card-user m-card-user--sm">\t\t\t\t\t\t\t\t<div class="m-card-user__pic">\t\t\t\t\t\t\t\t\t<div class="m-card-user__no-photo m--bg-fill-'+["success", "brand", "danger", "accent", "warning", "metal", "primary", "info"][e]+'"><span>'+t.CompanyAgent.substring(0, 1)+'</span></div>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="m-card-user__details">\t\t\t\t\t\t\t\t\t<span class="m-card-user__name">'+t.CompanyAgent+'</span>\t\t\t\t\t\t\t\t\t<a href="" class="m-card-user__email m-link">'+t.CompanyName+"</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>"
                    }
                    return output
                }
            }
            ...
            , {
                field:"Type", title:"Role", template:function(t) {
                    var a= {
                        1: {
